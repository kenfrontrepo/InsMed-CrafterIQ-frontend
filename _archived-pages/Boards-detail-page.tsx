...
function BoardDetailContent() {
  ...
  const displayName = boardData?.board_name || boardName || "";
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <AddPinsDialog
        ...
        boardName={displayName}
        userId={userId ?? ""}
        existingPinIds={boardData?.pins?.map((p) => p.id) ?? []}
